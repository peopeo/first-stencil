...
export class BimViewer {
  ...
  */
  ...
  showModel(currentViewer: Viewer, manifestFile: string) {
    ...
    //console.log("assetpath: ", getAssetPath("assets/westside/westside_manifest.json"));
    //setAssetPath(`${window.location.protocol}//${window.location.host}/`);
    console.log("assetpath: ", getAssetPath(""));
    ...
    const sceneModel = xktLoader.load({
      manifestSrc: `${manifestFile}`,
//      manifestSrc: `${getAssetPath("")}${manifestFile}`,
//      manifestSrc: `/bim/static/lib/${manifestFile}`,
      
      //manifestSrc: "/assets/" + manifestFile,
//      manifestSrc: "/assets/clinic/clinic_manifest.json",
     // manifestSrc: "/assets/westside/westside_manifest.json",
      id: "myModel",
    ...
    sceneModel.on("loaded", () => {
      console.log('sceneModel.on("loaded")');
  ...
  componentDidLoad() {
    ...
    new Grid({
      columns: [
        {
          ...
          formatter: (_, row) => {
            ...
            return hg('button', {
              ...
              onClick: () => this.currentViewer = this.showModel(this.currentViewer, `${row.cells[3].data}`)
            }, 'View');
          }
        },
        "id",
      ...
      data: [
        ...
        ["", "2hExBg8jj4NRG6zzE", "Westside River Hospital", "http://localhost:8069/bim/static/assets/westside/westside_manifest.json", "","2020-08-14T15:25:07", "IFC4", "20180328_1600(x64) - Exporter 19.0.1.1 - Alternate UI 19.0.1.1"],
        ["","3lMSBJ1J9AUQZulZKiGsht", "OTC Conference Center", "http://localhost:8069/bim/static/assets/otc/OTC_manifest.json", "", "2016-01-24T17:43:58", "IFC2X3", "20150702_1515(x64) - Exporter 15.5.0.0 - Alternate UI 15.5.0.0"],
        ["","3lMSBJ1J9AUQZulZKiGsht", "Clinic", "http://localhost:8069/bim/static/assets/clinic/clinic_manifest.json", "architect", "2015-08-27T14:54:09", "IFC2X3", "IFC file generated by Graphisoft ArchiCAD-64 18.0.0 NED FULL Windows version (IFC2x3 add-on version: 6000 NED FULL)."],
        ["","3lMSBJ1J9AUQZulZKiGsht", "10 Appartementen Schependomlaan", "http://localhost:8069/bim/static/assets/schependomlaan/schependoomlaan_manifest.json", "architect", "2015-08-27T14:54:09", "IFC2X3", "IFC file generated by Graphisoft ArchiCAD-64 18.0.0 NED FULL Windows version (IFC2x3 add-on version: 6000 NED FULL)."],
      ],
